 ...
 */
@Component
@FuncAttr(name = "跌停",type = FuncType.JudgeFunc)
public class LimitDown implements JudgeFuncInterface{

    public static final String funcName = LimitDown.class.getAnnotation(FuncAttr.class).name();
