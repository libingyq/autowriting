 ...
 */
@Component
@FuncAttr(name = "高开",type = FuncType.JudgeFunc)
public class OpenHigh implements JudgeFuncInterface{

    public static final String funcName = OpenHigh.class.getAnnotation(FuncAttr.class).name();
    ...
    public TwoTuple<Boolean,Double> judge(List<DataInfo> dataInfos) {
        ...
        boolean isHighStart = dataInfo.getSettlement() < dataInfo.getOpen() && hour == 9;
        return new TwoTuple<>(isHighStart,0.0) ;
    }
