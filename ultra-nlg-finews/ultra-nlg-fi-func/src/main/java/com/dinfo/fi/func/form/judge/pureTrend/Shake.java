 ...
 */
@Component
@FuncAttr(name = "震荡",type = FuncType.JudgeFunc)
public class Shake extends JudgeFuncBaseClass {
    public static final String funcName = Shake.class.getAnnotation(FuncAttr.class).name();
