...
public class GrabDataByCode implements ObjectFuncInterface{
    ...
    public List<DataInfo> queryData(QueryInfoConditionDto query) {
        ...
        Response stockByCodeAndTimeRange = stockDataService.getStockByCodeAndTimeRange(code, query.getStartTime(), query.getEndTime());
