 ...
 */
@Component
@FuncAttr(name = "关注下跌",type = FuncType.UpperFunc)
public class AttentionDown implements  UpperInter{
    ...
    public String reduce(String oriTemp) {
        ...
        List<String> strings = Lists.newArrayList(LimitDown.funcName, OpenLow.funcName,
                Down.funcName, DownAndShake.funcName, ShakeAndDown.funcName);
